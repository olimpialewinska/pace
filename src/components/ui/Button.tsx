  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-3xl text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        link: "relative text-primary underline-offset-4 transition-colors duration-300 before:absolute before:left-1/2 before:bottom-[4px] before:h-[2px] before:w-[calc(100%-28px)] before:origin-center before:scale-x-0 before:bg-current before:transition-transform before:duration-300 hover:before:scale-x-100 before:transform before:-translate-x-1/2",
      },
      size: {
